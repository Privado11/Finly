...
old_color_line = 'val color = if (dailyTotal > 0) ColorMoss else if (dailyTotal < 0) ColorBone else ColorSlate'
new_color_line = 'val color = if (dailyTotal > 0) ColorMoss else ColorSlate'
