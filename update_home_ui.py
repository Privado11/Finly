...
sig_card_old = "private fun TransactionsCard(transactions: List<Transaction>, categoryNames: Map<String, String>, onTransactionClick: (String) -> Unit, onNavigateToHistory: () -> Unit) {"
sig_card_new = "private fun TransactionsCard(transactions: List<Transaction>, categoryNames: Map<String, String>, categoryIcons: Map<String, String>, onTransactionClick: (String) -> Unit, onNavigateToHistory: () -> Unit) {"
content = content.replace(sig_card_old, sig_card_new)

call_old = "TransactionsCard(state.recentTransactions, state.categoryNames, onTransactionClick, onNavigateToHistory)"
call_new = "TransactionsCard(state.recentTransactions, state.categoryNames, state.categoryIcons, onTransactionClick, onNavigateToHistory)"
content = content.replace(call_old, call_new)

tx_call_old = "TxRow(tx, categoryNames, onTransactionClick)"
tx_call_new = "TxRow(tx, categoryNames, categoryIcons, onTransactionClick)"
